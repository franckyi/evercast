...
export default async function Home() {
  ...
  const featuredSolution = solutions.filter(solution => solution.categories.includes(17) && solution.meta.is_displayed_on_home)[0]
  ...
  return (
    <Section>
      ...
      {/* <RemainingSolutions solutions={homeSolutions} startIndex={1} limit={2} /> */}
